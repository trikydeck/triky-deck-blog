...
class SyntaxHighlighterStyle {
  ...
  static SyntaxHighlighterStyle lightThemeStyle() {
    return SyntaxHighlighterStyle(
        ...
        numberStyle: GoogleFonts.sourceCodePro(color: Color(0xFF1565C0)),
        commentStyle: GoogleFonts.firaCode(color: Color(0xFF9E9E9E)),
        keywordStyle: GoogleFonts.sourceCodePro(
            color: Color(0xFF9C27B0),
            fontStyle: FontStyle.italic,
            fontWeight: FontWeight.w500),
        stringStyle: GoogleFonts.sourceCodePro(color: Color(0xFF43A047)),
        punctuationStyle: GoogleFonts.sourceCodePro(color: Color(0xFF000000)),
        classStyle: GoogleFonts.sourceCodePro(
            color: Color(0xFF512DA8), fontWeight: FontWeight.w500),
        constantStyle: GoogleFonts.sourceCodePro(color: Color(0xFF795548)));
  }
  ...
  static SyntaxHighlighterStyle darkThemeStyle() {
    return SyntaxHighlighterStyle(
        ...
        commentStyle: GoogleFonts.firaCode(color: Color(0xFF9E9E9E)),
        keywordStyle: GoogleFonts.sourceCodePro(
            color: Colors.pink[300], //Color(0xFF80CBC4),
            fontStyle: FontStyle.italic,
            fontWeight: FontWeight.w500),
        stringStyle: GoogleFonts.sourceCodePro(color: Colors.lightGreen[600]),
        punctuationStyle: GoogleFonts.sourceCodePro(color: Color(0xFFFFFFFF)),
        classStyle: GoogleFonts.sourceCodePro(
